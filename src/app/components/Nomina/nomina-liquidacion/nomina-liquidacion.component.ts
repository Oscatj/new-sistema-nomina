...
import { NominaLiquidacion } from 'src/app/models/NominaLiquidacion';

@Component({
  selector: 'app-nomina-liquidacion',
  templateUrl: './nomina-liquidacion.component.html',
  styleUrls: ['./nomina-liquidacion.component.css']
})
export class NominaLiquidacionComponent implements OnInit {

  nomina : NominaLiquidacion [] = [];
